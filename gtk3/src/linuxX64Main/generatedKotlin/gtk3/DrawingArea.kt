...
inline fun Container.drawingArea(init: DrawingArea.() -> Unit = {}): DrawingArea =
        DrawingArea().apply { init(); this@drawingArea.add(this) }
 ...
 */
@GtkDsl
open class DrawingArea internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) :
        Widget() {
