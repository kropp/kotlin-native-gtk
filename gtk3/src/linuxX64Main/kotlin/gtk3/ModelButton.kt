...
inline fun Container.modelButton(init: ModelButton.() -> Unit = {}): ModelButton =
        ModelButton().apply { init(); this@modelButton.add(this) }
 ...
 */
@GtkDsl
open class ModelButton internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) :
        Button() {
