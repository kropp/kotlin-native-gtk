...
inline fun Container.eventBox(init: EventBox.() -> Unit = {}): EventBox = EventBox().apply { init(); this@eventBox.add(this) }
...
@GtkDsl
open class EventBox internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Bin() {
