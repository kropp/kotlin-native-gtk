...
inline fun Container.cellView(init: CellView.() -> Unit = {}): CellView = CellView().apply { init(); this@cellView.add(this) }
...
@GtkDsl
open class CellView internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Widget() {
    ...
    fun setBackgroundRgba(rgba: CPointer<GdkRGBA>?): Unit = gtk_cell_view_set_background_rgba(self, rgba)
}
