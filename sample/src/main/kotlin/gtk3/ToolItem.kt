...
inline fun Container.toolItem(init: ToolItem.() -> Unit = {}): ToolItem = ToolItem().apply { init(); this@toolItem.add(this) }

private fun ToolItem_onCreateMenuProxy_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<ToolItem>()?.get()?.onCreateMenuProxy?.invoke()
}

private fun ToolItem_onToolbarReconfigured_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<ToolItem>()?.get()?.onToolbarReconfigured?.invoke()
}
...
@GtkDsl
open class ToolItem internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Bin() {
    ...
    val onCreateMenuProxy: Signal<ToolItem, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<ToolItem, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "create-menu-proxy", staticCFunction(::ToolItem_onCreateMenuProxy_Handler)) }

    val onToolbarReconfigured: Signal<ToolItem, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<ToolItem, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "toolbar-reconfigured", staticCFunction(::ToolItem_onToolbarReconfigured_Handler)) }
    ...
    fun getProxyMenuItem(menu_item_id: String): CPointer<GtkWidget>? = gtk_tool_item_get_proxy_menu_item(self, menu_item_id)!!.reinterpret()
    ...
    fun retrieveProxyMenuItem(): CPointer<GtkWidget>? = gtk_tool_item_retrieve_proxy_menu_item(self)!!.reinterpret()
    ...
    fun setProxyMenuItem(menu_item_id: String, menu_item: CPointer<GtkWidget>?): Unit = gtk_tool_item_set_proxy_menu_item(self, menu_item_id, menu_item)
     ...
     *
     * See also #GtkToolItem::create-menu-proxy. */
    fun setProxyMenuItem(menu_item_id: String, menu_item: Widget): Unit = gtk_tool_item_set_proxy_menu_item(self, menu_item_id, menu_item.widgetPtr?.reinterpret())
