...
): FileChooserDialog = FileChooserDialog(title, parent, action, first_button_text).apply { init(); this@fileChooserDialog.add(this) }
...
@GtkDsl
open class FileChooserDialog internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Dialog() {
    ...
    constructor(
            ...
            action: GtkFileChooserAction,
            first_button_text: String
    ) : this(gtk_file_chooser_dialog_new(title, parent?.reinterpret(), action, first_button_text)?.reinterpret())
}
