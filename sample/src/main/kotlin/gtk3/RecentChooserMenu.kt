...
inline fun Container.recentChooserMenu(init: RecentChooserMenu.() -> Unit = {}): RecentChooserMenu = RecentChooserMenu().apply { init(); this@recentChooserMenu.add(this) }
...
@GtkDsl
open class RecentChooserMenu internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Menu() {
