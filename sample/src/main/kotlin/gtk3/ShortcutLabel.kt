...
inline fun Container.shortcutLabel(accelerator: String, init: ShortcutLabel.() -> Unit = {}): ShortcutLabel = ShortcutLabel(accelerator).apply { init(); this@shortcutLabel.add(this) }

/**
 * #GtkShortcutLabel is a widget that represents a single keyboard shortcut or gesture
 * in the user interface. */
@GtkDsl
open class ShortcutLabel internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Box() {
