...
): MessageDialog = MessageDialog(parent, flags, type, buttons, message_format).apply { init(); this@messageDialog.add(this) }
...
@GtkDsl
open class MessageDialog internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Dialog() {
    ...
    constructor(
            ...
            buttons: GtkButtonsType,
            message_format: String
    ) : this(gtk_message_dialog_new(parent?.reinterpret(), flags, type, buttons, message_format)?.reinterpret())
     ...
     * g_free (msg);
     * ]| */
    fun formatSecondaryMarkup(message_format: String): Unit = gtk_message_dialog_format_secondary_markup(self, message_format)

    /**
     * Sets the secondary text of the message dialog to be @message_format
     * (with printf()-style). */
    fun formatSecondaryText(message_format: String): Unit = gtk_message_dialog_format_secondary_text(self, message_format)
