...
inline fun Container.colorChooserWidget(init: ColorChooserWidget.() -> Unit = {}): ColorChooserWidget = ColorChooserWidget().apply { init(); this@colorChooserWidget.add(this) }
...
@GtkDsl
open class ColorChooserWidget internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Box() {
