...
inline fun Container.menu(init: Menu.() -> Unit = {}): Menu = Menu().apply { init(); this@menu.add(this) }
...
@GtkDsl
open class Menu internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : MenuShell() {
    ...
    fun attach(
            ...
            top_attach: Int,
            bottom_attach: Int
    ): Unit = gtk_menu_attach(self, child.widgetPtr?.reinterpret(), left_attach, right_attach, top_attach, bottom_attach)
    ...
    fun placeOnMonitor(monitor: CPointer<GdkMonitor>?): Unit = gtk_menu_place_on_monitor(self, monitor)
    ...
    fun popupAtPointer(trigger_event: CPointer<GdkEvent>?): Unit = gtk_menu_popup_at_pointer(self, trigger_event)
    ...
    ): Unit = gtk_menu_popup_at_rect(self, rect_window, rect, rect_anchor, menu_anchor, trigger_event)
     ...
     * children. */
    fun reorderChild(child: CPointer<GtkWidget>?, position: Int): Unit = gtk_menu_reorder_child(self, child, position)

    /**
     * Moves @child to a new @position in the list of @menu
     * children. */
    fun reorderChild(child: Widget, position: Int): Unit = gtk_menu_reorder_child(self, child.widgetPtr?.reinterpret(), position)
