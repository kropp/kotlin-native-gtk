...
inline fun Container.progressBar(init: ProgressBar.() -> Unit = {}): ProgressBar = ProgressBar().apply { init(); this@progressBar.add(this) }
...
@GtkDsl
open class ProgressBar internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Widget() {
