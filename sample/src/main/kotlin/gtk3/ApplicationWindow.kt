...
inline fun Container.applicationWindow(application: CPointer<GtkApplication>?, init: ApplicationWindow.() -> Unit = {}): ApplicationWindow = ApplicationWindow(application).apply { init(); this@applicationWindow.add(this) }
...
@GtkDsl
open class ApplicationWindow internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Window() {
    ...
    constructor(application: CPointer<GtkApplication>?) : this(gtk_application_window_new(application?.reinterpret()))
}
