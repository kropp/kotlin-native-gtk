...
open class RecentFilter() {
    ...
    fun addApplication(application: String): Unit = gtk_recent_filter_add_application(self, application)
     ...
     * is intended principally for use in the implementation of
     * #GtkRecentChooser. */
    fun filter(filter_info: CPointer<GtkRecentFilterInfo>?): Boolean = gtk_recent_filter_filter(self, filter_info) != 0
}
