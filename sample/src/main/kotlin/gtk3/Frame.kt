...
inline fun Container.frame(label: String, init: Frame.() -> Unit = {}): Frame = Frame(label).apply { init(); this@frame.add(this) }
...
open class Frame internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Bin() {
    ...
    fun setLabelAlign(xalign: Float, yalign: Float): Unit = gtk_frame_set_label_align(self, xalign, yalign)
}
