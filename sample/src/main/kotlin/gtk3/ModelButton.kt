...
import libgtk3.GtkModelButton
import libgtk3.GtkWidget
import libgtk3.gtk_model_button_new

inline fun Container.modelButton(init: ModelButton.() -> Unit = {}): ModelButton = ModelButton().apply { init(); this@modelButton.add(this) }
...
@GtkDsl
open class ModelButton internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Button() {
    private val self: CPointer<GtkModelButton>?
        get() = widgetPtr!!.reinterpret()

    val modelButton: CPointer<GtkModelButton>?
        get() = widgetPtr!!.reinterpret()
