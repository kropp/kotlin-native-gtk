...
inline fun Container.listBox(init: ListBox.() -> Unit = {}): ListBox = ListBox().apply { init(); this@listBox.add(this) }

private fun ListBox_onActivateCursorRow_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<ListBox>()?.get()?.onActivateCursorRow?.invoke()
}
...
private fun ListBox_onRowActivated_Handler(
    ...
    data?.asStableRef<ListBox>()?.get()?.onRowActivated?.invoke(row)
}
...
private fun ListBox_onRowSelected_Handler(
    ...
    data?.asStableRef<ListBox>()?.get()?.onRowSelected?.invoke(row)
}

private fun ListBox_onSelectAll_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<ListBox>()?.get()?.onSelectAll?.invoke()
}

private fun ListBox_onSelectedRowsChanged_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<ListBox>()?.get()?.onSelectedRowsChanged?.invoke()
}

private fun ListBox_onToggleCursorRow_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<ListBox>()?.get()?.onToggleCursorRow?.invoke()
}

private fun ListBox_onUnselectAll_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<ListBox>()?.get()?.onUnselectAll?.invoke()
}
...
@GtkDsl
open class ListBox internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Container() {
    ...
    val onActivateCursorRow: Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "activate-cursor-row", staticCFunction(::ListBox_onActivateCursorRow_Handler)) }
    ...
    val onRowActivated: Signal1<ListBox, CPointer<GtkListBoxRow>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkListBoxRow>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "row-activated", staticCFunction(::ListBox_onRowActivated_Handler)) }
    ...
    val onRowSelected: Signal1<ListBox, CPointer<GtkListBoxRow>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkListBoxRow>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "row-selected", staticCFunction(::ListBox_onRowSelected_Handler)) }

    val onSelectAll: Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "select-all", staticCFunction(::ListBox_onSelectAll_Handler)) }

    val onSelectedRowsChanged: Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "selected-rows-changed", staticCFunction(::ListBox_onSelectedRowsChanged_Handler)) }

    val onToggleCursorRow: Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "toggle-cursor-row", staticCFunction(::ListBox_onToggleCursorRow_Handler)) }

    val onUnselectAll: Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<ListBox, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "unselect-all", staticCFunction(::ListBox_onUnselectAll_Handler)) }
     ...
     * a drag leave event. */
    fun dragHighlightRow(row: CPointer<GtkListBoxRow>?): Unit = gtk_list_box_drag_highlight_row(self, row)
     ...
     * The row will also be unhighlighted when the widget gets
     * a drag leave event. */
    fun dragHighlightRow(row: ListBoxRow): Unit = gtk_list_box_drag_highlight_row(self, row.widgetPtr?.reinterpret())
    ...
    fun getRowAtIndex(index_: Int): CPointer<GtkListBoxRow>? = gtk_list_box_get_row_at_index(self, index_)!!.reinterpret()

    /**
     * Gets the row at the @y position. */
    fun getRowAtY(y: Int): CPointer<GtkListBoxRow>? = gtk_list_box_get_row_at_y(self, y)!!.reinterpret()
    ...
    fun insert(child: CPointer<GtkWidget>?, position: Int): Unit = gtk_list_box_insert(self, child, position)
     ...
     * If @position is -1, or larger than the total number of items in the
     * @box, then the @child will be appended to the end. */
    fun insert(child: Widget, position: Int): Unit = gtk_list_box_insert(self, child.widgetPtr?.reinterpret(), position)
    ...
    /**
     * Make @row the currently selected row. */
    fun selectRow(row: ListBoxRow): Unit = gtk_list_box_select_row(self, row.widgetPtr?.reinterpret())
    ...
    /**
     * Unselects a single row of @box, if the selection mode allows it. */
    fun unselectRow(row: ListBoxRow): Unit = gtk_list_box_unselect_row(self, row.widgetPtr?.reinterpret())

    /**
     * Sets the placeholder widget that is shown in the list when
     * it doesn't display any visible children. */
    fun setPlaceholder(placeholder: CPointer<GtkWidget>?): Unit = gtk_list_box_set_placeholder(self, placeholder)
}
