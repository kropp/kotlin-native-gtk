...
inline fun Container.toolPalette(init: ToolPalette.() -> Unit = {}): ToolPalette = ToolPalette().apply { init(); this@toolPalette.add(this) }
...
@GtkDsl
open class ToolPalette internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Container() {
    ...
    fun getDragItem(selection: CPointer<GtkSelectionData>?): CPointer<GtkWidget>? = gtk_tool_palette_get_drag_item(self, selection)!!.reinterpret()

    /**
     * Gets the group at position (x, y). */
    fun getDropGroup(x: Int, y: Int): CPointer<GtkToolItemGroup>? = gtk_tool_palette_get_drop_group(self, x, y)!!.reinterpret()

    /**
     * Gets the item at position (x, y).
     * See gtk_tool_palette_get_drop_group(). */
    fun getDropItem(x: Int, y: Int): CPointer<GtkToolItem>? = gtk_tool_palette_get_drop_item(self, x, y)!!.reinterpret()

    /**
     * Gets whether @group is exclusive or not.
     * See gtk_tool_palette_set_exclusive(). */
    fun getExclusive(group: CPointer<GtkToolItemGroup>?): Boolean = gtk_tool_palette_get_exclusive(self, group) != 0

    /**
     * Gets whether @group is exclusive or not.
     * See gtk_tool_palette_set_exclusive(). */
    fun getExclusive(group: ToolItemGroup): Boolean = gtk_tool_palette_get_exclusive(self, group.widgetPtr?.reinterpret()) != 0

    /**
     * Gets whether group should be given extra space.
     * See gtk_tool_palette_set_expand(). */
    fun getExpand(group: CPointer<GtkToolItemGroup>?): Boolean = gtk_tool_palette_get_expand(self, group) != 0

    /**
     * Gets whether group should be given extra space.
     * See gtk_tool_palette_set_expand(). */
    fun getExpand(group: ToolItemGroup): Boolean = gtk_tool_palette_get_expand(self, group.widgetPtr?.reinterpret()) != 0

    /**
     * Gets the position of @group in @palette as index.
     * See gtk_tool_palette_set_group_position(). */
    fun getGroupPosition(group: CPointer<GtkToolItemGroup>?): Int = gtk_tool_palette_get_group_position(self, group)

    /**
     * Gets the position of @group in @palette as index.
     * See gtk_tool_palette_set_group_position(). */
    fun getGroupPosition(group: ToolItemGroup): Int = gtk_tool_palette_get_group_position(self, group.widgetPtr?.reinterpret())

    /**
     * Sets whether the group should be exclusive or not.
     * If an exclusive group is expanded all other groups are collapsed. */
    fun setExclusive(group: CPointer<GtkToolItemGroup>?, exclusive: Boolean): Unit = gtk_tool_palette_set_exclusive(self, group, if (exclusive) gtk_true() else gtk_false())

    /**
     * Sets whether the group should be exclusive or not.
     * If an exclusive group is expanded all other groups are collapsed. */
    fun setExclusive(group: ToolItemGroup, exclusive: Boolean): Unit = gtk_tool_palette_set_exclusive(self, group.widgetPtr?.reinterpret(), if (exclusive) gtk_true() else gtk_false())

    /**
     * Sets whether the group should be given extra space. */
    fun setExpand(group: CPointer<GtkToolItemGroup>?, expand: Boolean): Unit = gtk_tool_palette_set_expand(self, group, if (expand) gtk_true() else gtk_false())

    /**
     * Sets whether the group should be given extra space. */
    fun setExpand(group: ToolItemGroup, expand: Boolean): Unit = gtk_tool_palette_set_expand(self, group.widgetPtr?.reinterpret(), if (expand) gtk_true() else gtk_false())

    /**
     * Sets the position of the group as an index of the tool palette.
     * If position is 0 the group will become the first child, if position is
     * -1 it will become the last child. */
    fun setGroupPosition(group: CPointer<GtkToolItemGroup>?, position: Int): Unit = gtk_tool_palette_set_group_position(self, group, position)

    /**
     * Sets the position of the group as an index of the tool palette.
     * If position is 0 the group will become the first child, if position is
     * -1 it will become the last child. */
    fun setGroupPosition(group: ToolItemGroup, position: Int): Unit = gtk_tool_palette_set_group_position(self, group.widgetPtr?.reinterpret(), position)
    ...
    fun setDragSource(targets: GtkToolPaletteDragTargets): Unit = gtk_tool_palette_set_drag_source(self, targets)
}
