...
inline fun Container.radioToolButton(group: CPointer<GSList>?, init: RadioToolButton.() -> Unit = {}): RadioToolButton = RadioToolButton(group).apply { init(); this@radioToolButton.add(this) }
...
@GtkDsl
open class RadioToolButton internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : ToggleToolButton() {
    ...
    constructor(group: CPointer<GSList>?) : this(gtk_radio_tool_button_new(group?.reinterpret())?.reinterpret<GtkWidget>())
}
