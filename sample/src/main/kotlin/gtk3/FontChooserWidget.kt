...
inline fun Container.fontChooserWidget(init: FontChooserWidget.() -> Unit = {}): FontChooserWidget = FontChooserWidget().apply { init(); this@fontChooserWidget.add(this) }
...
@GtkDsl
open class FontChooserWidget internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Box() {
