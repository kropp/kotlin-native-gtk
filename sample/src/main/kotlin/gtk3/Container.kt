...
import libgtk3.gtk_container_set_focus_chain
...
import libgtk3.gtk_container_unset_focus_chain
...
private fun Container_onAdd_Handler(
    ...
    data?.asStableRef<Container>()?.get()?.onAdd?.invoke(`object`)
}

private fun Container_onCheckResize_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Container>()?.get()?.onCheckResize?.invoke()
}
...
private fun Container_onRemove_Handler(
    ...
    data?.asStableRef<Container>()?.get()?.onRemove?.invoke(`object`)
}
...
private fun Container_onSetFocusChild_Handler(
    ...
    data?.asStableRef<Container>()?.get()?.onSetFocusChild?.invoke(`object`)
}
...
abstract class Container : Widget() {
    ...
    val onCheckResize: Signal<Container, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Container, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "check-resize", staticCFunction(::Container_onCheckResize_Handler)) }
    ...
    val onSetFocusChild: Signal1<Container, CPointer<GtkWidget>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkWidget>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "set-focus-child", staticCFunction(::Container_onSetFocusChild_Handler)) }
    ...
    fun addWithProperties(widget: CPointer<GtkWidget>?, first_prop_name: String): Unit = gtk_container_add_with_properties(self, widget, first_prop_name)

    /**
     * Adds @widget to @container, setting child properties at the same time.
     * See gtk_container_add() and gtk_container_child_set() for more details. */
    fun addWithProperties(widget: Widget, first_prop_name: String): Unit = gtk_container_add_with_properties(self, widget.widgetPtr?.reinterpret(), first_prop_name)

    fun checkResize(): Unit = gtk_container_check_resize(self)

    /**
     * Gets the values of one or more child properties for @child and @container. */
    fun childGet(child: CPointer<GtkWidget>?, first_prop_name: String): Unit = gtk_container_child_get(self, child, first_prop_name)

    /**
     * Gets the values of one or more child properties for @child and @container. */
    fun childGet(child: Widget, first_prop_name: String): Unit = gtk_container_child_get(self, child.widgetPtr?.reinterpret(), first_prop_name)
    ...
    fun childNotify(child: CPointer<GtkWidget>?, child_property: String): Unit = gtk_container_child_notify(self, child, child_property)
     ...
     *
     * Also see gtk_widget_child_notify(). */
    fun childNotify(child: Widget, child_property: String): Unit = gtk_container_child_notify(self, child.widgetPtr?.reinterpret(), child_property)

    /**
     * Sets one or more child properties for @child and @container. */
    fun childSet(child: CPointer<GtkWidget>?, first_prop_name: String): Unit = gtk_container_child_set(self, child, first_prop_name)

    /**
     * Sets one or more child properties for @child and @container. */
    fun childSet(child: Widget, first_prop_name: String): Unit = gtk_container_child_set(self, child.widgetPtr?.reinterpret(), first_prop_name)

    /**
     * Returns a newly created widget path representing all the widget hierarchy
     * from the toplevel down to and including @child. */
    fun getPathForChild(child: CPointer<GtkWidget>?): CPointer<GtkWidgetPath>? = gtk_container_get_path_for_child(self, child)!!.reinterpret()

    /**
     * Returns a newly created widget path representing all the widget hierarchy
     * from the toplevel down to and including @child. */
    fun getPathForChild(child: Widget): CPointer<GtkWidgetPath>? = gtk_container_get_path_for_child(self, child.widgetPtr?.reinterpret())!!.reinterpret()
    ...
    fun unsetFocusChain(): Unit = gtk_container_unset_focus_chain(self)
    ...
    fun setFocusChain(focusable_widgets: CPointer<GList>?): Unit = gtk_container_set_focus_chain(self, focusable_widgets)
}
