...
@GtkDsl
open class Viewport internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Bin() {
    ...
    constructor(hadjustment: CPointer<GtkAdjustment>?, vadjustment: CPointer<GtkAdjustment>?) : this(gtk_viewport_new(hadjustment?.reinterpret(), vadjustment?.reinterpret())?.reinterpret())
}
