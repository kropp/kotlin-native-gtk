...
inline fun Container.recentChooserWidget(init: RecentChooserWidget.() -> Unit = {}): RecentChooserWidget = RecentChooserWidget().apply { init(); this@recentChooserWidget.add(this) }
...
@GtkDsl
open class RecentChooserWidget internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Box() {
