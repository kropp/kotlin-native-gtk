...
): AppChooserDialog = AppChooserDialog(parent, flags, file).apply { init(); this@appChooserDialog.add(this) }
...
@GtkDsl
open class AppChooserDialog internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Dialog() {
    ...
    constructor(
            ...
            flags: GtkDialogFlags,
            file: CPointer<GFile>?
    ) : this(gtk_app_chooser_dialog_new(parent?.reinterpret(), flags, file?.reinterpret())?.reinterpret())
}
