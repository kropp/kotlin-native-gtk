...
inline fun Container.spinner(init: Spinner.() -> Unit = {}): Spinner = Spinner().apply { init(); this@spinner.add(this) }
...
@GtkDsl
open class Spinner internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Widget() {
