...
@GtkDsl
open class Box internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Container() {
    ...
    constructor(orientation: GtkOrientation, spacing: Int) : this(gtk_box_new(orientation, spacing)?.reinterpret())
    ...
    fun packEnd(
            ...
            fill: Boolean,
            padding: Int
    ): Unit = gtk_box_pack_end(self, child, if (expand) gtk_true() else gtk_false(), if (fill) gtk_true() else gtk_false(), padding)
    ...
    fun packEnd(
            ...
            fill: Boolean,
            padding: Int
    ): Unit = gtk_box_pack_end(self, child.widgetPtr?.reinterpret(), if (expand) gtk_true() else gtk_false(), if (fill) gtk_true() else gtk_false(), padding)
    ...
    fun packStart(
            ...
            fill: Boolean,
            padding: Int
    ): Unit = gtk_box_pack_start(self, child, if (expand) gtk_true() else gtk_false(), if (fill) gtk_true() else gtk_false(), padding)
    ...
    fun packStart(
            ...
            fill: Boolean,
            padding: Int
    ): Unit = gtk_box_pack_start(self, child.widgetPtr?.reinterpret(), if (expand) gtk_true() else gtk_false(), if (fill) gtk_true() else gtk_false(), padding)
    ...
    fun reorderChild(child: CPointer<GtkWidget>?, position: Int): Unit = gtk_box_reorder_child(self, child, position)
     ...
     * in the list will be packed just after all other widgets of the
     * same packing type that appear earlier in the list. */
    fun reorderChild(child: Widget, position: Int): Unit = gtk_box_reorder_child(self, child.widgetPtr?.reinterpret(), position)
    ...
    ): Unit = gtk_box_set_child_packing(self, child, if (expand) gtk_true() else gtk_false(), if (fill) gtk_true() else gtk_false(), padding, pack_type)
    ...
    fun setChildPacking(
            ...
            padding: Int,
            pack_type: GtkPackType
    ): Unit = gtk_box_set_child_packing(self, child.widgetPtr?.reinterpret(), if (expand) gtk_true() else gtk_false(), if (fill) gtk_true() else gtk_false(), padding, pack_type)
}
