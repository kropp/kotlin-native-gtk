...
inline fun Container.separatorToolItem(init: SeparatorToolItem.() -> Unit = {}): SeparatorToolItem = SeparatorToolItem().apply { init(); this@separatorToolItem.add(this) }
...
@GtkDsl
open class SeparatorToolItem internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : ToolItem() {
