...
inline fun Container.menuButton(init: MenuButton.() -> Unit = {}): MenuButton = MenuButton().apply { init(); this@menuButton.add(this) }
...
@GtkDsl
open class MenuButton internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : ToggleButton() {
