...
inline fun Container.textView(init: TextView.() -> Unit = {}): TextView = TextView().apply { init(); this@textView.add(this) }

private fun TextView_onBackspace_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TextView>()?.get()?.onBackspace?.invoke()
}

private fun TextView_onCopyClipboard_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TextView>()?.get()?.onCopyClipboard?.invoke()
}

private fun TextView_onCutClipboard_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TextView>()?.get()?.onCutClipboard?.invoke()
}

private fun TextView_onInsertEmoji_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TextView>()?.get()?.onInsertEmoji?.invoke()
}

private fun TextView_onPasteClipboard_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TextView>()?.get()?.onPasteClipboard?.invoke()
}
...
private fun TextView_onPopulatePopup_Handler(
    ...
    data?.asStableRef<TextView>()?.get()?.onPopulatePopup?.invoke(popup)
}

private fun TextView_onSetAnchor_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TextView>()?.get()?.onSetAnchor?.invoke()
}

private fun TextView_onToggleCursorVisible_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TextView>()?.get()?.onToggleCursorVisible?.invoke()
}

private fun TextView_onToggleOverwrite_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TextView>()?.get()?.onToggleOverwrite?.invoke()
}
 ...
 * of the main node. */
@GtkDsl
open class TextView internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Container() {
    ...
    val onBackspace: Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "backspace", staticCFunction(::TextView_onBackspace_Handler)) }

    val onCopyClipboard: Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "copy-clipboard", staticCFunction(::TextView_onCopyClipboard_Handler)) }

    val onCutClipboard: Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "cut-clipboard", staticCFunction(::TextView_onCutClipboard_Handler)) }

    val onInsertEmoji: Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "insert-emoji", staticCFunction(::TextView_onInsertEmoji_Handler)) }

    val onPasteClipboard: Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "paste-clipboard", staticCFunction(::TextView_onPasteClipboard_Handler)) }
    ...
    val onPopulatePopup: Signal1<TextView, CPointer<GtkWidget>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkWidget>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "populate-popup", staticCFunction(::TextView_onPopulatePopup_Handler)) }

    val onSetAnchor: Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "set-anchor", staticCFunction(::TextView_onSetAnchor_Handler)) }

    val onToggleCursorVisible: Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "toggle-cursor-visible", staticCFunction(::TextView_onToggleCursorVisible_Handler)) }

    val onToggleOverwrite: Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TextView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "toggle-overwrite", staticCFunction(::TextView_onToggleOverwrite_Handler)) }
    ...
    fun addChildAtAnchor(child: CPointer<GtkWidget>?, anchor: CPointer<GtkTextChildAnchor>?): Unit = gtk_text_view_add_child_at_anchor(self, child, anchor)
    ...
    fun addChildInWindow(
            ...
            xpos: Int,
            ypos: Int
    ): Unit = gtk_text_view_add_child_in_window(self, child.widgetPtr?.reinterpret(), which_window, xpos, ypos)
    ...
    fun backwardDisplayLine(iter: CPointer<GtkTextIter>?): Boolean = gtk_text_view_backward_display_line(self, iter) != 0
     ...
     * they depend on the view’s width; paragraphs are the same in all
     * views, since they depend on the contents of the #GtkTextBuffer. */
    fun backwardDisplayLineStart(iter: CPointer<GtkTextIter>?): Boolean = gtk_text_view_backward_display_line_start(self, iter) != 0
     ...
     * they depend on the view’s width; paragraphs are the same in all
     * views, since they depend on the contents of the #GtkTextBuffer. */
    fun forwardDisplayLine(iter: CPointer<GtkTextIter>?): Boolean = gtk_text_view_forward_display_line(self, iter) != 0
     ...
     * they depend on the view’s width; paragraphs are the same in all
     * views, since they depend on the contents of the #GtkTextBuffer. */
    fun forwardDisplayLineEnd(iter: CPointer<GtkTextIter>?): Boolean = gtk_text_view_forward_display_line_end(self, iter) != 0

    /**
     * Gets the width of the specified border window. See
     * gtk_text_view_set_border_window_size(). */
    fun getBorderWindowSize(type: GtkTextWindowType): Int = gtk_text_view_get_border_window_size(self, type)
     ...
     * realized. */
    fun getWindow(win: GtkTextWindowType): CPointer<GdkWindow>? = gtk_text_view_get_window(self, win)!!.reinterpret()
    ...
    fun getWindowType(window: CPointer<GdkWindow>?): GtkTextWindowType = gtk_text_view_get_window_type(self, window)
     ...
     * }
     * ]| */
    fun imContextFilterKeypress(event: CPointer<GdkEventKey>?): Boolean = gtk_text_view_im_context_filter_keypress(self, event) != 0
    ...
    fun moveMarkOnscreen(mark: CPointer<GtkTextMark>?): Boolean = gtk_text_view_move_mark_onscreen(self, mark) != 0
    ...
    fun moveVisually(iter: CPointer<GtkTextIter>?, count: Int): Boolean = gtk_text_view_move_visually(self, iter, count) != 0
    ...
    fun scrollMarkOnscreen(mark: CPointer<GtkTextMark>?): Unit = gtk_text_view_scroll_mark_onscreen(self, mark)
    ...
    fun scrollToIter(
            ...
            xalign: Double,
            yalign: Double
    ): Boolean = gtk_text_view_scroll_to_iter(self, iter, within_margin, if (use_align) gtk_true() else gtk_false(), xalign, yalign) != 0
    ...
    fun scrollToMark(
            ...
            xalign: Double,
            yalign: Double
    ): Unit = gtk_text_view_scroll_to_mark(self, mark, within_margin, if (use_align) gtk_true() else gtk_false(), xalign, yalign)
    ...
    fun setBorderWindowSize(type: GtkTextWindowType, size: Int): Unit = gtk_text_view_set_border_window_size(self, type, size)

    /**
     * Determines whether @iter is at the start of a display line.
     * See gtk_text_view_forward_display_line() for an explanation of
     * display lines vs. paragraphs. */
    fun startsDisplayLine(iter: CPointer<GtkTextIter>?): Boolean = gtk_text_view_starts_display_line(self, iter) != 0
}
