...
inline fun Container.comboBoxText(init: ComboBoxText.() -> Unit = {}): ComboBoxText = ComboBoxText().apply { init(); this@comboBoxText.add(this) }
...
@GtkDsl
open class ComboBoxText internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : ComboBox() {
     ...
     * ID string. */
    fun insertText(position: Int, text: String): Unit = gtk_combo_box_text_insert_text(self, position, text)
