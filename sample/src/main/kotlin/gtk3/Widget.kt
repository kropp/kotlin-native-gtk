...
private fun Widget_onAccelClosuresChanged_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onAccelClosuresChanged?.invoke()
}
...
private fun Widget_onButtonPressEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onButtonPressEvent?.invoke(event)
}
...
private fun Widget_onButtonReleaseEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onButtonReleaseEvent?.invoke(event)
}
...
private fun Widget_onCanActivateAccel_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onCanActivateAccel?.invoke(signal_id)
}

private fun Widget_onCompositedChanged_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onCompositedChanged?.invoke()
}
...
private fun Widget_onConfigureEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onConfigureEvent?.invoke(event)
}
...
private fun Widget_onDamageEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onDamageEvent?.invoke(event)
}
...
private fun Widget_onDeleteEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onDeleteEvent?.invoke(event)
}

private fun Widget_onDestroy_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onDestroy?.invoke()
}
...
private fun Widget_onDestroyEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onDestroyEvent?.invoke(event)
}
...
private fun Widget_onDragBegin_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onDragBegin?.invoke(context)
}
...
private fun Widget_onDragDataDelete_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onDragDataDelete?.invoke(context)
}
...
private fun Widget_onDragDrop_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onDragDrop?.invoke(context, x, y, time)
}
...
private fun Widget_onDragEnd_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onDragEnd?.invoke(context)
}
...
private fun Widget_onDragLeave_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onDragLeave?.invoke(context, time)
}
...
private fun Widget_onDragMotion_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onDragMotion?.invoke(context, x, y, time)
}
...
private fun Widget_onEnterNotifyEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onEnterNotifyEvent?.invoke(event)
}
...
private fun Widget_onEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onEvent?.invoke(event)
}
...
private fun Widget_onEventAfter_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onEventAfter?.invoke(event)
}
...
private fun Widget_onFocusInEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onFocusInEvent?.invoke(event)
}
...
private fun Widget_onFocusOutEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onFocusOutEvent?.invoke(event)
}
...
private fun Widget_onGrabBrokenEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onGrabBrokenEvent?.invoke(event)
}

private fun Widget_onGrabFocus_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onGrabFocus?.invoke()
}

private fun Widget_onHide_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onHide?.invoke()
}
...
private fun Widget_onHierarchyChanged_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onHierarchyChanged?.invoke(previous_toplevel)
}
...
private fun Widget_onKeyPressEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onKeyPressEvent?.invoke(event)
}
...
private fun Widget_onKeyReleaseEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onKeyReleaseEvent?.invoke(event)
}
...
private fun Widget_onLeaveNotifyEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onLeaveNotifyEvent?.invoke(event)
}

private fun Widget_onMap_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onMap?.invoke()
}
...
private fun Widget_onMapEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onMapEvent?.invoke(event)
}
...
private fun Widget_onMotionNotifyEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onMotionNotifyEvent?.invoke(event)
}
...
private fun Widget_onParentSet_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onParentSet?.invoke(old_parent)
}

private fun Widget_onPopupMenu_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onPopupMenu?.invoke()
}
...
private fun Widget_onPropertyNotifyEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onPropertyNotifyEvent?.invoke(event)
}
...
private fun Widget_onProximityInEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onProximityInEvent?.invoke(event)
}
...
private fun Widget_onProximityOutEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onProximityOutEvent?.invoke(event)
}

private fun Widget_onRealize_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onRealize?.invoke()
}
...
private fun Widget_onScreenChanged_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onScreenChanged?.invoke(previous_screen)
}
...
private fun Widget_onScrollEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onScrollEvent?.invoke(event)
}
...
private fun Widget_onSelectionClearEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onSelectionClearEvent?.invoke(event)
}
...
private fun Widget_onSelectionNotifyEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onSelectionNotifyEvent?.invoke(event)
}
...
private fun Widget_onSelectionRequestEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onSelectionRequestEvent?.invoke(event)
}

private fun Widget_onShow_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onShow?.invoke()
}
...
private fun Widget_onSizeAllocate_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onSizeAllocate?.invoke(allocation)
}

private fun Widget_onStateFlagsChanged_Handler(
        sender: CPointer<*>?,
        flags: GtkStateFlags,
        data: COpaquePointer?
) {
    data?.asStableRef<Widget>()?.get()?.onStateFlagsChanged?.invoke(flags)
}
...
private fun Widget_onStyleSet_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onStyleSet?.invoke(previous_style)
}

private fun Widget_onStyleUpdated_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onStyleUpdated?.invoke()
}
...
private fun Widget_onTouchEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onTouchEvent?.invoke(`object`)
}

private fun Widget_onUnmap_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onUnmap?.invoke()
}
...
private fun Widget_onUnmapEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onUnmapEvent?.invoke(event)
}

private fun Widget_onUnrealize_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<Widget>()?.get()?.onUnrealize?.invoke()
}
...
private fun Widget_onVisibilityNotifyEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onVisibilityNotifyEvent?.invoke(event)
}
...
private fun Widget_onWindowStateEvent_Handler(
    ...
    data?.asStableRef<Widget>()?.get()?.onWindowStateEvent?.invoke(event)
}
...
abstract class Widget {
    ...
    val onAccelClosuresChanged: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "accel-closures-changed", staticCFunction(::Widget_onAccelClosuresChanged_Handler)) }
    ...
    val onButtonPressEvent: Signal1<Widget, CPointer<GdkEventButton>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventButton>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "button-press-event", staticCFunction(::Widget_onButtonPressEvent_Handler)) }
    ...
    val onButtonReleaseEvent: Signal1<Widget, CPointer<GdkEventButton>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventButton>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "button-release-event", staticCFunction(::Widget_onButtonReleaseEvent_Handler)) }

    val onCanActivateAccel: Signal1<Widget, Int, CFunction<(
            CPointer<*>?,
            Int,
            COpaquePointer?
    ) -> Unit>> by lazy { Signal1<Widget, Int, CFunction<(
                    CPointer<*>?,
                    Int,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "can-activate-accel", staticCFunction(::Widget_onCanActivateAccel_Handler)) }

    val onCompositedChanged: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "composited-changed", staticCFunction(::Widget_onCompositedChanged_Handler)) }
    ...
    val onConfigureEvent: Signal1<Widget, CPointer<GdkEventConfigure>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventConfigure>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "configure-event", staticCFunction(::Widget_onConfigureEvent_Handler)) }
    ...
    val onDamageEvent: Signal1<Widget, CPointer<GdkEventExpose>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventExpose>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "damage-event", staticCFunction(::Widget_onDamageEvent_Handler)) }
    ...
    val onDeleteEvent: Signal1<Widget, CPointer<GdkEvent>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEvent>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "delete-event", staticCFunction(::Widget_onDeleteEvent_Handler)) }

    val onDestroy: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "destroy", staticCFunction(::Widget_onDestroy_Handler)) }
    ...
    val onDestroyEvent: Signal1<Widget, CPointer<GdkEvent>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEvent>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "destroy-event", staticCFunction(::Widget_onDestroyEvent_Handler)) }
    ...
    val onDragBegin: Signal1<Widget, CPointer<GdkDragContext>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkDragContext>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "drag-begin", staticCFunction(::Widget_onDragBegin_Handler)) }
    ...
    val onDragDataDelete: Signal1<Widget, CPointer<GdkDragContext>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkDragContext>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "drag-data-delete", staticCFunction(::Widget_onDragDataDelete_Handler)) }

    val onDragDrop: Signal4<Widget, CPointer<GdkDragContext>?, Int, Int, Int, CFunction<(
            CPointer<*>?,
            CPointer<GdkDragContext>?,
            Int,
            Int,
            Int,
            COpaquePointer?
    ) -> Unit>> by lazy { Signal4<Widget, CPointer<GdkDragContext>?, Int, Int, Int, CFunction<(
                    CPointer<*>?,
                    CPointer<GdkDragContext>?,
                    Int,
                    Int,
                    Int,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "drag-drop", staticCFunction(::Widget_onDragDrop_Handler)) }
    ...
    val onDragLeave: Signal2<Widget, CPointer<GdkDragContext>?, Int, CFunction<(
            CPointer<*>?,
            CPointer<GdkDragContext>?,
            Int,
            COpaquePointer?
    ) -> Unit>> by lazy { Signal2<Widget, CPointer<GdkDragContext>?, Int, CFunction<(
                    CPointer<*>?,
                    CPointer<GdkDragContext>?,
                    Int,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "drag-leave", staticCFunction(::Widget_onDragLeave_Handler)) }

    val onDragMotion: Signal4<Widget, CPointer<GdkDragContext>?, Int, Int, Int, CFunction<(
            CPointer<*>?,
            CPointer<GdkDragContext>?,
            Int,
            Int,
            ...
            COpaquePointer?
                    ...
                    Int,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "drag-motion", staticCFunction(::Widget_onDragMotion_Handler)) }
    ...
    val onEnterNotifyEvent: Signal1<Widget, CPointer<GdkEventCrossing>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventCrossing>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "enter-notify-event", staticCFunction(::Widget_onEnterNotifyEvent_Handler)) }
    ...
    val onEventAfter: Signal1<Widget, CPointer<GdkEvent>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEvent>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "event-after", staticCFunction(::Widget_onEventAfter_Handler)) }
    ...
    val onFocusInEvent: Signal1<Widget, CPointer<GdkEventFocus>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventFocus>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "focus-in-event", staticCFunction(::Widget_onFocusInEvent_Handler)) }
    ...
    val onFocusOutEvent: Signal1<Widget, CPointer<GdkEventFocus>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventFocus>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "focus-out-event", staticCFunction(::Widget_onFocusOutEvent_Handler)) }
    ...
    val onGrabBrokenEvent: Signal1<Widget, CPointer<GdkEventGrabBroken>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventGrabBroken>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "grab-broken-event", staticCFunction(::Widget_onGrabBrokenEvent_Handler)) }

    val onGrabFocus: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "grab-focus", staticCFunction(::Widget_onGrabFocus_Handler)) }

    val onHide: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "hide", staticCFunction(::Widget_onHide_Handler)) }
    ...
    val onHierarchyChanged: Signal1<Widget, CPointer<GtkWidget>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkWidget>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "hierarchy-changed", staticCFunction(::Widget_onHierarchyChanged_Handler)) }
    ...
    val onKeyPressEvent: Signal1<Widget, CPointer<GdkEventKey>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventKey>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "key-press-event", staticCFunction(::Widget_onKeyPressEvent_Handler)) }
    ...
    val onKeyReleaseEvent: Signal1<Widget, CPointer<GdkEventKey>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventKey>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "key-release-event", staticCFunction(::Widget_onKeyReleaseEvent_Handler)) }
    ...
    val onLeaveNotifyEvent: Signal1<Widget, CPointer<GdkEventCrossing>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventCrossing>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "leave-notify-event", staticCFunction(::Widget_onLeaveNotifyEvent_Handler)) }

    val onMap: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "map", staticCFunction(::Widget_onMap_Handler)) }
    ...
    val onMapEvent: Signal1<Widget, CPointer<GdkEventAny>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventAny>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "map-event", staticCFunction(::Widget_onMapEvent_Handler)) }
    ...
    val onMotionNotifyEvent: Signal1<Widget, CPointer<GdkEventMotion>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventMotion>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "motion-notify-event", staticCFunction(::Widget_onMotionNotifyEvent_Handler)) }
    ...
    val onParentSet: Signal1<Widget, CPointer<GtkWidget>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkWidget>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "parent-set", staticCFunction(::Widget_onParentSet_Handler)) }

    val onPopupMenu: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "popup-menu", staticCFunction(::Widget_onPopupMenu_Handler)) }
    ...
    val onPropertyNotifyEvent: Signal1<Widget, CPointer<GdkEventProperty>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventProperty>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "property-notify-event", staticCFunction(::Widget_onPropertyNotifyEvent_Handler)) }
    ...
    val onProximityInEvent: Signal1<Widget, CPointer<GdkEventProximity>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventProximity>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "proximity-in-event", staticCFunction(::Widget_onProximityInEvent_Handler)) }
    ...
    val onProximityOutEvent: Signal1<Widget, CPointer<GdkEventProximity>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventProximity>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "proximity-out-event", staticCFunction(::Widget_onProximityOutEvent_Handler)) }

    val onRealize: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "realize", staticCFunction(::Widget_onRealize_Handler)) }
    ...
    val onScreenChanged: Signal1<Widget, CPointer<GdkScreen>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkScreen>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "screen-changed", staticCFunction(::Widget_onScreenChanged_Handler)) }
    ...
    val onScrollEvent: Signal1<Widget, CPointer<GdkEventScroll>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventScroll>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "scroll-event", staticCFunction(::Widget_onScrollEvent_Handler)) }
    ...
    val onSelectionClearEvent: Signal1<Widget, CPointer<GdkEventSelection>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventSelection>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "selection-clear-event", staticCFunction(::Widget_onSelectionClearEvent_Handler)) }
    ...
    val onSelectionNotifyEvent: Signal1<Widget, CPointer<GdkEventSelection>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventSelection>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "selection-notify-event", staticCFunction(::Widget_onSelectionNotifyEvent_Handler)) }
    ...
    val onSelectionRequestEvent: Signal1<Widget, CPointer<GdkEventSelection>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventSelection>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "selection-request-event", staticCFunction(::Widget_onSelectionRequestEvent_Handler)) }

    val onShow: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "show", staticCFunction(::Widget_onShow_Handler)) }
    ...
    val onSizeAllocate: Signal1<Widget, CPointer<GtkAllocation>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkAllocation>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "size-allocate", staticCFunction(::Widget_onSizeAllocate_Handler)) }

    val onStateFlagsChanged: Signal1<Widget, GtkStateFlags, CFunction<(
            CPointer<*>?,
            GtkStateFlags,
            COpaquePointer?
    ) -> Unit>> by lazy { Signal1<Widget, GtkStateFlags, CFunction<(
                    CPointer<*>?,
                    GtkStateFlags,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "state-flags-changed", staticCFunction(::Widget_onStateFlagsChanged_Handler)) }
    ...
    val onStyleSet: Signal1<Widget, CPointer<GtkStyle>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkStyle>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "style-set", staticCFunction(::Widget_onStyleSet_Handler)) }

    val onStyleUpdated: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "style-updated", staticCFunction(::Widget_onStyleUpdated_Handler)) }
    ...
    val onTouchEvent: Signal1<Widget, CPointer<GdkEvent>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEvent>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "touch-event", staticCFunction(::Widget_onTouchEvent_Handler)) }

    val onUnmap: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "unmap", staticCFunction(::Widget_onUnmap_Handler)) }
    ...
    val onUnmapEvent: Signal1<Widget, CPointer<GdkEventAny>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventAny>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "unmap-event", staticCFunction(::Widget_onUnmapEvent_Handler)) }

    val onUnrealize: Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<Widget, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "unrealize", staticCFunction(::Widget_onUnrealize_Handler)) }
    ...
    val onVisibilityNotifyEvent: Signal1<Widget, CPointer<GdkEventVisibility>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventVisibility>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "visibility-notify-event", staticCFunction(::Widget_onVisibilityNotifyEvent_Handler)) }
    ...
    val onWindowStateEvent: Signal1<Widget, CPointer<GdkEventWindowState>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GdkEventWindowState>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "window-state-event", staticCFunction(::Widget_onWindowStateEvent_Handler)) }
    ...
    ): Unit = gtk_widget_add_accelerator(self, accel_signal, accel_group, accel_key, accel_mods, accel_flags)

    /**
     * Adds the device events in the bitfield @events to the event mask for
     * @widget. See gtk_widget_set_device_events() for details. */
    fun addDeviceEvents(device: CPointer<GdkDevice>?, events: GdkEventMask): Unit = gtk_widget_add_device_events(self, device, events)
    ...
    fun addMnemonicLabel(label: CPointer<GtkWidget>?): Unit = gtk_widget_add_mnemonic_label(self, label)
     ...
     * its internal state at this point as well, by using a connection
     * to the #GtkWidget::destroy signal or a weak notifier. */
    fun addMnemonicLabel(label: Widget): Unit = gtk_widget_add_mnemonic_label(self, label.widgetPtr?.reinterpret())
    ...
    fun canActivateAccel(signal_id: Int): Boolean = gtk_widget_can_activate_accel(self, signal_id) != 0
    ...
    fun childFocus(direction: GtkDirectionType): Boolean = gtk_widget_child_focus(self, direction) != 0
    ...
    fun computeExpand(orientation: GtkOrientation): Boolean = gtk_widget_compute_expand(self, orientation) != 0
    ...
    fun deviceIsShadowed(device: CPointer<GdkDevice>?): Boolean = gtk_widget_device_is_shadowed(self, device) != 0
    ...
    fun dragBeginWithCoordinates(
            ...
            x: Int,
            y: Int
    ): CPointer<GdkDragContext>? = gtk_drag_begin_with_coordinates(self, targets, actions, button, event, x, y)!!.reinterpret()
     ...
     * drag-and-drop. */
    fun dragDestGetTargetList(): CPointer<GtkTargetList>? = gtk_drag_dest_get_target_list(self)!!.reinterpret()
     ...
     * gtk_drag_dest_set(). */
    fun dragDestSetTargetList(target_list: CPointer<GtkTargetList>?): Unit = gtk_drag_dest_set_target_list(self, target_list)
    ...
    fun dragDestSetTrackMotion(track_motion: Boolean): Unit = gtk_drag_dest_set_track_motion(self, if (track_motion) gtk_true() else gtk_false())
     ...
     * drag-and-drop. */
    fun dragSourceGetTargetList(): CPointer<GtkTargetList>? = gtk_drag_source_get_target_list(self)!!.reinterpret()

    /**
     * Sets the icon that will be used for drags from a particular source
     * to @icon. See the docs for #GtkIconTheme for more details. */
    fun dragSourceSetIconGicon(icon: CPointer<GIcon>?): Unit = gtk_drag_source_set_icon_gicon(self, icon)

    /**
     * Sets the icon that will be used for drags from a particular source
     * to a themed icon. See the docs for #GtkIconTheme for more details. */
    fun dragSourceSetIconName(icon_name: String): Unit = gtk_drag_source_set_icon_name(self, icon_name)

    /**
     * Sets the icon that will be used for drags from a particular widget
     * from a #GdkPixbuf. GTK+ retains a reference for @pixbuf and will
     * release it when it is no longer needed. */
    fun dragSourceSetIconPixbuf(pixbuf: CPointer<GdkPixbuf>?): Unit = gtk_drag_source_set_icon_pixbuf(self, pixbuf)

    /**
     * Changes the target types that this widget offers for drag-and-drop.
     * The widget must first be made into a drag source with
     * gtk_drag_source_set(). */
    fun dragSourceSetTargetList(target_list: CPointer<GtkTargetList>?): Unit = gtk_drag_source_set_target_list(self, target_list)
    ...
    fun getActionGroup(prefix: String): CPointer<libgtk3.GActionGroup>? = gtk_widget_get_action_group(self, prefix)!!.reinterpret()

    /**
     * Returns whether @device can interact with @widget and its
     * children. See gtk_widget_set_device_enabled(). */
    fun getDeviceEnabled(device: CPointer<GdkDevice>?): Boolean = gtk_widget_get_device_enabled(self, device) != 0

    /**
     * Returns the events mask for the widget corresponding to an specific device. These
     * are the events that the widget will receive when @device operates on it. */
    fun getDeviceEvents(device: CPointer<GdkDevice>?): GdkEventMask = gtk_widget_get_device_events(self, device)
    ...
    fun getModifierMask(intent: GdkModifierIntent): GdkModifierType = gtk_widget_get_modifier_mask(self, intent)
     ...
     * from @widget. */
    fun insertActionGroup(name: String, group: CPointer<libgtk3.GActionGroup>?): Unit = gtk_widget_insert_action_group(self, name, group)

    /**
     * Determines whether @widget is somewhere inside @ancestor, possibly with
     * intermediate containers. */
    fun isAncestor(ancestor: CPointer<GtkWidget>?): Boolean = gtk_widget_is_ancestor(self, ancestor) != 0

    /**
     * Determines whether @widget is somewhere inside @ancestor, possibly with
     * intermediate containers. */
    fun isAncestor(ancestor: Widget): Boolean = gtk_widget_is_ancestor(self, ancestor.widgetPtr?.reinterpret()) != 0
    ...
    fun keynavFailed(direction: GtkDirectionType): Boolean = gtk_widget_keynav_failed(self, direction) != 0
     ...
     * widgets afterwards. */
    fun listMnemonicLabels(): CPointer<GList>? = gtk_widget_list_mnemonic_labels(self)!!.reinterpret()
    ...
    fun mnemonicActivate(group_cycling: Boolean): Boolean = gtk_widget_mnemonic_activate(self, if (group_cycling) gtk_true() else gtk_false()) != 0
    ...
    fun removeMnemonicLabel(label: CPointer<GtkWidget>?): Unit = gtk_widget_remove_mnemonic_label(self, label)
     ...
     * must have previously been added to the list with
     * gtk_widget_add_mnemonic_label(). */
    fun removeMnemonicLabel(label: Widget): Unit = gtk_widget_remove_mnemonic_label(self, label.widgetPtr?.reinterpret())

    /**
     * Removes a tick callback previously registered with
     * gtk_widget_add_tick_callback(). */
    fun removeTickCallback(id: Int): Unit = gtk_widget_remove_tick_callback(self, id)
     ...
     * ]| */
    fun sendFocusChange(event: CPointer<GdkEvent>?): Boolean = gtk_widget_send_focus_change(self, event) != 0
    ...
    fun setAccelPath(accel_path: String, accel_group: CPointer<GtkAccelGroup>?): Unit = gtk_widget_set_accel_path(self, accel_path, accel_group)
    ...
    fun setDeviceEnabled(device: CPointer<GdkDevice>?, enabled: Boolean): Unit = gtk_widget_set_device_enabled(self, device, if (enabled) gtk_true() else gtk_false())
    ...
    fun setDeviceEvents(device: CPointer<GdkDevice>?, events: GdkEventMask): Unit = gtk_widget_set_device_events(self, device, events)
    ...
    fun setSizeRequest(width: Int, height: Int): Unit = gtk_widget_set_size_request(self, width, height)
    ...
    fun setStateFlags(flags: GtkStateFlags, clear: Boolean): Unit = gtk_widget_set_state_flags(self, flags, if (clear) gtk_true() else gtk_false())
     ...
     * instead. */
    fun sizeAllocate(allocation: CPointer<GtkAllocation>?): Unit = gtk_widget_size_allocate(self, allocation)
    ...
    fun sizeAllocateWithBaseline(allocation: CPointer<GtkAllocation>?, baseline: Int): Unit = gtk_widget_size_allocate_with_baseline(self, allocation, baseline)

    /**
     * Gets the values of a multiple style properties of @widget. */
    fun styleGet(first_property_name: String): Unit = gtk_widget_style_get(self, first_property_name)
    ...
    fun unregisterWindow(window: CPointer<GdkWindow>?): Unit = gtk_widget_unregister_window(self, window)
     ...
     * allocation. */
    fun setAllocation(allocation: CPointer<GtkAllocation>?): Unit = gtk_widget_set_allocation(self, allocation)
    ...
    fun setRedrawOnAllocate(redraw_on_allocate: Boolean): Unit = gtk_widget_set_redraw_on_allocate(self, if (redraw_on_allocate) gtk_true() else gtk_false())
}
