...
inline fun Container.offscreenWindow(init: OffscreenWindow.() -> Unit = {}): OffscreenWindow = OffscreenWindow().apply { init(); this@offscreenWindow.add(this) }
...
@GtkDsl
open class OffscreenWindow internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Window() {
