...
inline fun Container.checkButton(init: CheckButton.() -> Unit = {}): CheckButton = CheckButton().apply { init(); this@checkButton.add(this) }
 ...
 * in this case. */
@GtkDsl
open class CheckButton internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : ToggleButton() {
