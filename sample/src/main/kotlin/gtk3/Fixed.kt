...
inline fun Container.fixed(init: Fixed.() -> Unit = {}): Fixed = Fixed().apply { init(); this@fixed.add(this) }
...
@GtkDsl
open class Fixed internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Container() {
