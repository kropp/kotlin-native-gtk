...
private fun ShortcutsSection_onChangeCurrentPage_Handler(
    ...
    data?.asStableRef<ShortcutsSection>()?.get()?.onChangeCurrentPage?.invoke(`object`)
}
...
abstract class ShortcutsSection : Box() {
    ...
    val onChangeCurrentPage: Signal1<ShortcutsSection, Int, CFunction<(
            ...
            COpaquePointer?
                    ...
                    Int,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "change-current-page", staticCFunction(::ShortcutsSection_onChangeCurrentPage_Handler)) }
}
