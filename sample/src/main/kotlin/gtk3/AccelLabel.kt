...
inline fun Container.accelLabel(string: String, init: AccelLabel.() -> Unit = {}): AccelLabel = AccelLabel(string).apply { init(); this@accelLabel.add(this) }
...
@GtkDsl
open class AccelLabel internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Label() {
    ...
    fun setAccel(accelerator_key: Int, accelerator_mods: GdkModifierType): Unit = gtk_accel_label_set_accel(self, accelerator_key, accelerator_mods)
}
