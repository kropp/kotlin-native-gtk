...
inline fun Container.image(init: Image.() -> Unit = {}): Image = Image().apply { init(); this@image.add(this) }
...
open class Image internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Misc() {
    ...
    fun setFromGicon(icon: CPointer<GIcon>?, size: GtkIconSize): Unit = gtk_image_set_from_gicon(self, icon, size)

    /**
     * See gtk_image_new_from_icon_name() for details. */
    fun setFromIconName(icon_name: String, size: GtkIconSize): Unit = gtk_image_set_from_icon_name(self, icon_name, size)
    ...
    fun setFromResource(resource_path: String): Unit = gtk_image_set_from_resource(self, resource_path)
}
