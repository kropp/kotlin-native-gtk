...
inline fun Container.lockButton(permission: CPointer<GPermission>?, init: LockButton.() -> Unit = {}): LockButton = LockButton(permission).apply { init(); this@lockButton.add(this) }
...
@GtkDsl
open class LockButton internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Button() {
    ...
    constructor(permission: CPointer<GPermission>?) : this(gtk_lock_button_new(permission))
}
