...
): RecentChooserDialog = RecentChooserDialog(title, parent, first_button_text).apply { init(); this@recentChooserDialog.add(this) }
...
@GtkDsl
open class RecentChooserDialog internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Dialog() {
    ...
    constructor(
            ...
            parent: CPointer<GtkWindow>?,
            first_button_text: String
    ) : this(gtk_recent_chooser_dialog_new(title, parent?.reinterpret(), first_button_text)?.reinterpret())
}
