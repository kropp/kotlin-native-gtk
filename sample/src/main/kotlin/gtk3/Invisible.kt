...
inline fun Container.invisible(init: Invisible.() -> Unit = {}): Invisible = Invisible().apply { init(); this@invisible.add(this) }
 ...
 * for drag-and-drop. */
@GtkDsl
open class Invisible internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Widget() {
