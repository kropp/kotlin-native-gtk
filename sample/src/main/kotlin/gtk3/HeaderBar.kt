...
inline fun Container.headerBar(init: HeaderBar.() -> Unit = {}): HeaderBar = HeaderBar().apply { init(); this@headerBar.add(this) }
...
@GtkDsl
open class HeaderBar internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Container() {
     ...
     * Adds @child to @bar, packed with reference to the
     * start of the @bar. */
    fun packStart(child: Widget): Unit = gtk_header_bar_pack_start(self, child.widgetPtr?.reinterpret())
}
