...
@GtkDsl
open class Scrollbar internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Range() {
    ...
    constructor(orientation: GtkOrientation, adjustment: CPointer<GtkAdjustment>?) : this(gtk_scrollbar_new(orientation, adjustment?.reinterpret())?.reinterpret())
}
