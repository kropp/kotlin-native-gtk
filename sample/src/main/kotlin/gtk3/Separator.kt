...
inline fun Container.separator(orientation: GtkOrientation, init: Separator.() -> Unit = {}): Separator = Separator(orientation).apply { init(); this@separator.add(this) }
...
@GtkDsl
open class Separator internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Widget() {
