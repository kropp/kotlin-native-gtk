...
@GtkDsl
open class Layout internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Container() {
    ...
    constructor(hadjustment: CPointer<GtkAdjustment>?, vadjustment: CPointer<GtkAdjustment>?) : this(gtk_layout_new(hadjustment?.reinterpret(), vadjustment?.reinterpret())?.reinterpret())
    ...
    fun setSize(width: Int, height: Int): Unit = gtk_layout_set_size(self, width, height)
}
