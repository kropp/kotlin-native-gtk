...
private fun Scale_onFormatValue_Handler(
    ...
    data?.asStableRef<Scale>()?.get()?.onFormatValue?.invoke(value)
}
...
open class Scale internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Range() {
    ...
    val onFormatValue: Signal1<Scale, Double, CFunction<(
            ...
            COpaquePointer?
                    ...
                    Double,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "format-value", staticCFunction(::Scale_onFormatValue_Handler)) }
    ...
    constructor(orientation: GtkOrientation, adjustment: CPointer<GtkAdjustment>?) : this(gtk_scale_new(orientation, adjustment?.reinterpret())?.reinterpret())
