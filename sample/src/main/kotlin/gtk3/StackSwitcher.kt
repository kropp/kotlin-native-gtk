...
inline fun Container.stackSwitcher(init: StackSwitcher.() -> Unit = {}): StackSwitcher = StackSwitcher().apply { init(); this@stackSwitcher.add(this) }
 ...
 * stack pages. */
@GtkDsl
open class StackSwitcher internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Box() {
