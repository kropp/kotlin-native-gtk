...
inline fun Container.stackSidebar(init: StackSidebar.() -> Unit = {}): StackSidebar = StackSidebar().apply { init(); this@stackSidebar.add(this) }
 ...
 * pages. */
@GtkDsl
open class StackSidebar internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Bin() {
