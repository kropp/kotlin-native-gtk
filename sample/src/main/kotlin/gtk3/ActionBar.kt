...
inline fun Container.actionBar(init: ActionBar.() -> Unit = {}): ActionBar = ActionBar().apply { init(); this@actionBar.add(this) }
...
@GtkDsl
open class ActionBar internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Bin() {
     ...
     * Adds @child to @action_bar, packed with reference to the
     * start of the @action_bar. */
    fun packStart(child: Widget): Unit = gtk_action_bar_pack_start(self, child.widgetPtr?.reinterpret())
}
