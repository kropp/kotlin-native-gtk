...
inline fun Container.treeView(init: TreeView.() -> Unit = {}): TreeView = TreeView().apply { init(); this@treeView.add(this) }

private fun TreeView_onColumnsChanged_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TreeView>()?.get()?.onColumnsChanged?.invoke()
}

private fun TreeView_onCursorChanged_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TreeView>()?.get()?.onCursorChanged?.invoke()
}
...
private fun TreeView_onRowActivated_Handler(
    ...
    data?.asStableRef<TreeView>()?.get()?.onRowActivated?.invoke(path, column)
}
...
private fun TreeView_onRowCollapsed_Handler(
    ...
    data?.asStableRef<TreeView>()?.get()?.onRowCollapsed?.invoke(iter, path)
}
...
private fun TreeView_onRowExpanded_Handler(
    ...
    data?.asStableRef<TreeView>()?.get()?.onRowExpanded?.invoke(iter, path)
}

private fun TreeView_onSelectAll_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TreeView>()?.get()?.onSelectAll?.invoke()
}

private fun TreeView_onSelectCursorParent_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TreeView>()?.get()?.onSelectCursorParent?.invoke()
}

private fun TreeView_onStartInteractiveSearch_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TreeView>()?.get()?.onStartInteractiveSearch?.invoke()
}
...
private fun TreeView_onTestCollapseRow_Handler(
    ...
    data?.asStableRef<TreeView>()?.get()?.onTestCollapseRow?.invoke(iter, path)
}
...
private fun TreeView_onTestExpandRow_Handler(
    ...
    data?.asStableRef<TreeView>()?.get()?.onTestExpandRow?.invoke(iter, path)
}

private fun TreeView_onToggleCursorRow_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TreeView>()?.get()?.onToggleCursorRow?.invoke()
}

private fun TreeView_onUnselectAll_Handler(sender: CPointer<*>?, data: COpaquePointer?) {
    data?.asStableRef<TreeView>()?.get()?.onUnselectAll?.invoke()
}
...
@GtkDsl
open class TreeView internal constructor(override val widgetPtr: CPointer<GtkWidget>? = null) : Container() {
    ...
    val onColumnsChanged: Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "columns-changed", staticCFunction(::TreeView_onColumnsChanged_Handler)) }

    val onCursorChanged: Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "cursor-changed", staticCFunction(::TreeView_onCursorChanged_Handler)) }

    val onRowActivated: Signal2<TreeView, CPointer<GtkTreePath>?, CPointer<GtkTreeViewColumn>?, CFunction<(
            CPointer<*>?,
            CPointer<GtkTreePath>?,
            CPointer<GtkTreeViewColumn>?,
            COpaquePointer?
    ) -> Unit>> by lazy { Signal2<TreeView, CPointer<GtkTreePath>?, CPointer<GtkTreeViewColumn>?, CFunction<(
                    CPointer<*>?,
                    CPointer<GtkTreePath>?,
                    CPointer<GtkTreeViewColumn>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "row-activated", staticCFunction(::TreeView_onRowActivated_Handler)) }
    ...
    val onRowCollapsed: Signal2<TreeView, CPointer<GtkTreeIter>?, CPointer<GtkTreePath>?, CFunction<(
            ...
            CPointer<GtkTreePath>?,
            COpaquePointer?
    ) -> Unit>> by lazy { Signal2<TreeView, CPointer<GtkTreeIter>?, CPointer<GtkTreePath>?, CFunction<(
                    CPointer<*>?,
                    CPointer<GtkTreeIter>?,
                    CPointer<GtkTreePath>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "row-collapsed", staticCFunction(::TreeView_onRowCollapsed_Handler)) }
    ...
    val onRowExpanded: Signal2<TreeView, CPointer<GtkTreeIter>?, CPointer<GtkTreePath>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkTreePath>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "row-expanded", staticCFunction(::TreeView_onRowExpanded_Handler)) }

    val onSelectAll: Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "select-all", staticCFunction(::TreeView_onSelectAll_Handler)) }

    val onSelectCursorParent: Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "select-cursor-parent", staticCFunction(::TreeView_onSelectCursorParent_Handler)) }

    val onStartInteractiveSearch: Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "start-interactive-search", staticCFunction(::TreeView_onStartInteractiveSearch_Handler)) }

    val onTestCollapseRow: Signal2<TreeView, CPointer<GtkTreeIter>?, CPointer<GtkTreePath>?, CFunction<(
            CPointer<*>?,
            CPointer<GtkTreeIter>?,
            CPointer<GtkTreePath>?,
            COpaquePointer?
                    ...
                    CPointer<GtkTreePath>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "test-collapse-row", staticCFunction(::TreeView_onTestCollapseRow_Handler)) }
    ...
    val onTestExpandRow: Signal2<TreeView, CPointer<GtkTreeIter>?, CPointer<GtkTreePath>?, CFunction<(
            ...
            COpaquePointer?
                    ...
                    CPointer<GtkTreePath>?,
                    COpaquePointer?
            ) -> Unit>>(widgetPtr!!, this, "test-expand-row", staticCFunction(::TreeView_onTestExpandRow_Handler)) }

    val onToggleCursorRow: Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "toggle-cursor-row", staticCFunction(::TreeView_onToggleCursorRow_Handler)) }

    val onUnselectAll: Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>> by lazy { Signal<TreeView, CFunction<(CPointer<*>?, COpaquePointer?) -> Unit>>(widgetPtr!!, this, "unselect-all", staticCFunction(::TreeView_onUnselectAll_Handler)) }
    ...
    fun appendColumn(column: CPointer<GtkTreeViewColumn>?): Int = gtk_tree_view_append_column(self, column)

    /**
     * Appends @column to the list of columns. If @tree_view has “fixed_height”
     * mode enabled, then @column must have its “sizing” property set to be
     * GTK_TREE_VIEW_COLUMN_FIXED. */
    fun appendColumn(column: TreeViewColumn): Int = gtk_tree_view_append_column(self, column.widgetPtr?.reinterpret())
    ...
    fun collapseRow(path: CPointer<GtkTreePath>?): Boolean = gtk_tree_view_collapse_row(self, path) != 0
    ...
    fun expandRow(path: CPointer<GtkTreePath>?, open_all: Boolean): Boolean = gtk_tree_view_expand_row(self, path, if (open_all) gtk_true() else gtk_false()) != 0
    ...
    fun getColumn(n: Int): CPointer<GtkTreeViewColumn>? = gtk_tree_view_get_column(self, n)!!.reinterpret()
    ...
    fun insertColumn(column: CPointer<GtkTreeViewColumn>?, position: Int): Int = gtk_tree_view_insert_column(self, column, position)
     ...
     * “fixed_height” mode enabled, then @column must have its “sizing” property
     * set to be GTK_TREE_VIEW_COLUMN_FIXED. */
    fun insertColumn(column: TreeViewColumn, position: Int): Int = gtk_tree_view_insert_column(self, column.widgetPtr?.reinterpret(), position)
    ...
    fun moveColumnAfter(column: CPointer<GtkTreeViewColumn>?, base_column: CPointer<GtkTreeViewColumn>?): Unit = gtk_tree_view_move_column_after(self, column, base_column)

    /**
     * Moves @column to be after to @base_column.  If @base_column is %NULL, then
     * @column is placed in the first position. */
    fun moveColumnAfter(column: TreeViewColumn, base_column: TreeViewColumn): Unit = gtk_tree_view_move_column_after(self, column.widgetPtr?.reinterpret(), base_column.widgetPtr?.reinterpret())

    /**
     * Removes @column from @tree_view. */
    fun removeColumn(column: CPointer<GtkTreeViewColumn>?): Int = gtk_tree_view_remove_column(self, column)

    /**
     * Removes @column from @tree_view. */
    fun removeColumn(column: TreeViewColumn): Int = gtk_tree_view_remove_column(self, column.widgetPtr?.reinterpret())

    /**
     * Activates the cell determined by @path and @column. */
    fun rowActivated(path: CPointer<GtkTreePath>?, column: CPointer<GtkTreeViewColumn>?): Unit = gtk_tree_view_row_activated(self, path, column)

    /**
     * Returns %TRUE if the node pointed to by @path is expanded in @tree_view. */
    fun rowExpanded(path: CPointer<GtkTreePath>?): Boolean = gtk_tree_view_row_expanded(self, path) != 0
    ...
    fun scrollToCell(
            ...
            row_align: Float,
            col_align: Float
    ): Unit = gtk_tree_view_scroll_to_cell(self, path, column, if (use_align) gtk_true() else gtk_false(), row_align, col_align)
    ...
    fun scrollToPoint(tree_x: Int, tree_y: Int): Unit = gtk_tree_view_scroll_to_point(self, tree_x, tree_y)
    ...
    ): Unit = gtk_tree_view_set_cursor(self, path, focus_column, if (start_editing) gtk_true() else gtk_false())
    ...
    fun setCursorOnCell(
            ...
            start_editing: Boolean
    ): Unit = gtk_tree_view_set_cursor_on_cell(self, path, focus_column, focus_cell, if (start_editing) gtk_true() else gtk_false())

    /**
     * Sets the row that is highlighted for feedback.
     * If @path is %NULL, an existing highlight is removed. */
    fun setDragDestRow(path: CPointer<GtkTreePath>?, pos: GtkTreeViewDropPosition): Unit = gtk_tree_view_set_drag_dest_row(self, path, pos)
    ...
    fun setTooltipRow(tooltip: CPointer<GtkTooltip>?, path: CPointer<GtkTreePath>?): Unit = gtk_tree_view_set_tooltip_row(self, tooltip, path)
